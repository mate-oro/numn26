...
if __name__ == '__main__':
    ...
    beam_problemCV = aode.Explicit_Problem(beam_class.rhs, y0=np.zeros((2*beam_class.ndofs,))) # type: ignore
    beam_problemCV.name='Modified Elastodyn example from DUNE-FEM'
    print("CVProblem done.")

    beam_sim = aso.ImplicitEuler(beam_problemCV)
    beam_sim.h = 0.05
    beam_sim.report_continuously = True
