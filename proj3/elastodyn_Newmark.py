...
if __name__ == '__main__':
    ...
    from secondOrderODE import Linear_ODE_2nd_Order as LODE2, Explicit_Problem_2nd_lin as EP2, Newmark_lin
    ...
    for i, t in enumerate(tt):
        ...
        if t > plottime:
            #print(f"Beam position at t={t}")            beam_class.plotBeam( y[i], fig )
